...
export default function Searcher() {
    ...
    return (
        <div className='flex justify-center items-center py-2'>
            ...
            <input onChange={handleInputChange} type='text' name='search' id='search' placeholder='Search' className='block w-[600px] py-2 m-1 rounded-sm bg-gray-800 indent-8 focus:outline-none text-white font-sora text-md'/>
        </div>
    )
}