...
export default function Searcher() {
    ...
    return (
        <div className='flex justify-center items-center py-2'>
            ...
            <input onChange={handleInputChange} type='text' name='search' id='search' placeholder='Search' className='block w-[600px] py-2 m-1 rounded-xl border-2 border-gray-800 indent-8 focus:outline-none text-gray-500 font-sora text-md'/>
        </div>
    )
}