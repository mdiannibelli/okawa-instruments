...
export default function Searcher() {
    ...
    return (
        <div className='flex justify-center items-center py-2'>
            ...
            <input onChange={handleInputChange} type='text' name='search' id='search' placeholder='Search' className='block w-[600px] py-2 m-2 rounded-sm bg-gray-200 indent-8 focus:outline-none text-gray-500 font-sora text-md'/>
        </div>
    )
}