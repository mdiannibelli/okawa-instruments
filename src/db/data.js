const guitarsProducts = [
    ...
    },
    {
        ...
        description: `Fusionando el diseño clásico de Fender® con características centradas en el guitarrista y nuevos y emocionantes acabados, la Player Plus Stratocaster® ofrece una comodidad excelente y un estilo inconfundible. En el corazón de esta Strat® hay un trío de pastillas Player Plus Noiseless™: brillantes y sensibles al tacto, ofrecen el tono clásico de Strat sin zumbidos. Un potenciómetro push-pull en el control de tono agrega la pastilla del mástil para cambiar las posiciones 1 y 2 para dos sonidos que normalmente no se encuentran en una Strat®. El mástil sedoso satinado Modern "C" Player Plus Strat® se adapta a tu mano como un guante, con bordes suaves y redondeados para una comodidad suprema. El diapasón de 12” de radio y los 22 trastes médium jumbo facilitan la fluidez de los solos y bendings sin esfuerzo. Suave y receptivo, el trémolo de 2 puntos proporciona efectos de vibrato clásicos, mientras que los clavijeros de bloqueo brindan una afinación sólida y hacen que los cambios de cuerda sean rápidos y fáciles. Con el estilo clásico de Fender, funciones avanzadas y acabados nuevos e impresionantes, la Player Plus Stratocaster es la herramienta perfecta para despertar tu creatividad y destacar entre la multitud.`,
    ...
    },
    {
        ...
        description: `La serie Fender® American Vintage II presenta una versión notablemente precisa de los diseños revolucionarios que alteraron el curso de la historia musical. Construidos con cuerpos, mástiles y herrajes precisos de la época, acabados de primera calidad y pastillas específicas del año con una sonoridad meticulosa, cada instrumento captura la esencia de la auténtica artesanía y el tono de Fender. Con sus atractivas curvas, sonidos chispeantes y su innovador puente de trémolo, la nueva Stratocaster® de 1954 de Fender fue un fenómeno, diferente a todo lo que el mundo había visto antes. En 1957, la Stratocaster se había cristalizado en una obra maestra de mediados de siglo. Con un trío de pastillas Pure Vintage '57 Stratocaster, contornos de cuerpo amplios y un mástil en forma de "V" sumamente cómodo con un diapasón de arce de radio de 7.25 ", la American Vintage II 1957 Stratocaster reproduce el tono y la sensación por excelencia del original. Otras citas incluyen un trémolo sincronizado de precisión vintage con bloque de acero laminado en frío y monturas de acero doblado, clavijero "Fender Deluxe" en línea y un golpeador de una sola capa. Ofrecida en tres impresionantes acabados de laca de nitrocelulosa: 2-Color Sunburst y Sea Foam Green sobre aliso y Vintage Blonde sobre fresno, la American Vintage II 1957 Stratocaster celebra un verdadero ícono del diseño de instrumentos Fender. Los instrumentos de la serie American Vintage II son descendientes directos de los Fender originales: diseñados para músicos con una gran apreciación por el tono y la sensación de Fender vintage y construidos con una calidad inigualable, hasta el último tornillo. Estas son las eléctricas Fender en su forma más pura: Fender American Vintage II, el material de las leyendas.`,
        finish: 'Sunburst',
        color: 'https://i.gyazo.com/be5f2e58d458d03c2ec898948c313004.png',
        handedness: 'Left',
        category: 'Stratocaster',
    ...
    },
    {
        ...
        description: `La serie Fender® American Vintage II presenta una versión notablemente precisa de los diseños revolucionarios que alteraron el curso de la historia musical. Construidos con cuerpos, mástiles y herrajes precisos de la época, acabados de primera calidad y pastillas específicas del año con una sonoridad meticulosa, cada instrumento captura la esencia de la auténtica artesanía y el tono de Fender. Durante finales de los años 50 y principios de los 60, la popularidad de los instrumentos musicales Fender floreció y, aunque la variedad de Fender se había ampliado para incluir muchos instrumentos nuevos y fantásticos, la Stratocaster® reinaba por encima de todo. Para 1961, la Stratocaster había adquirido una estética más refinada, con un Sunburst de 3 colores reformulado con un rojo más vibrante y un borde negro más audaz, rematado con un golpeador de 3 capas que acentuaba las curvas características de la Stratocaster. Con un cuerpo de aliso de primera calidad, un trío de pastillas Pure Vintage 1961 Stratocaster y un mástil de arce en forma de "C" mediano acoplado con un diapasón de palisandro de 7,25" de radio, la American Vintage II 1961 Stratocaster reproduce el tono y la sensación por excelencia de la original. Otras citas incluyen un trémolo sincronizado de precisión vintage con bloque de acero laminado en frío y monturas de acero doblado, sintonizadores "Fender Deluxe" de una sola línea y golpeador de 3 capas. Los instrumentos de la serie American Vintage II son descendientes directos de los Fender originales: diseñados para músicos con una gran apreciación por el tono y la sensación de Fender vintage y construidos con una calidad inigualable, hasta el último tornillo. Estas son las eléctricas Fender en su forma más pura: Fender American Vintage II, el material de las leyendas.`,
